...
class Response_Frame(tk.CTkFrame):
    ...
    def __init__(self, master, **kwargs):
        ...
        self.preview_label = tk.CTkButton(master=self.special_options_frame, text="👁️",
                                          font=tk.CTkFont("Arial", 16, underline=False, weight="bold"), width=20,
                                          fg_color="transparent", hover=False)
        self.preview_label.pack(side="right")
        self.ai_label = tk.CTkButton(master=self.special_options_frame, text="✨",
                                     font=tk.CTkFont("Arial", 16, underline=False, weight="bold"), width=20,
                                     fg_color="transparent", hover=False,
        ...
        self.default_frame.response_text = SmartTextbox(master=self.default_frame, main_master=self.master, wrap="word",
                                                        state="normal", undo=True)
        # pack
        ...
        self.RFA_frame.response_text = SmartTextbox(main_master=self.master, master=self.RFA_frame, wrap="word",
                                                    state="disabled", height=60)
        self.RFA_frame.RFA_option = tk.CTkSegmentedButton(master=self.RFA_frame,
                                                          values=["Admit", "Deny", "Lack Info", "Custom"],
                                                          border_width=0, command=master.setRFA)
        self.RFA_frame.RFA_label = tk.CTkLabel(master=self.RFA_frame, text="17.1 RESPONSE:", font=label_font)
        self.RFA_frame.RFA_text = SmartTextbox(main_master=self.master, master=self.RFA_frame, wrap="word",
                                               state="normal", height=60)
        ...
        self.RFP_frame.response_text = SmartTextbox(main_master=self.master, master=self.RFP_frame, wrap="word",
                                                    state="disabled")
        ...
        self.RFP_frame.RFP_option = tk.CTkSegmentedButton(master=self.RFP_frame,
                                                          values=["Available", "Not Exist", "Not Possessed", "Lost",
                                                                  "Custom"], border_width=0, command=master.setRFP)
