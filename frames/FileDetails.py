...
class File_Details_Frame(tk.CTkFrame):
    ...
    def __init__(self,master, **kwargs):
        ...
        if warning!=False:
            ...
            self.name_warning = tk.CTkButton(master=self.file_name_frame,text="!",width=10,hover=False,fg_color="red")
        ...
        self.name = SmartTextbox(main_master=self.master,master=self.file_name_frame,height=40,wrap="word",font=font,text_color=text_col,fg_color=bg_col,corner_radius=r)
        ...
        if warning!=False:
            ...
            self.document_warning = tk.CTkButton(master=self.document_frame,text="!",width=10,hover=False,fg_color="red")
        ...
        self.document = SmartTextbox(main_master=self.master,master=self.document_frame,height=40,wrap="word",font=font,text_color=text_col,fg_color=bg_col,corner_radius=r)
        ...
        if warning!=False:
            ...
            self.county_warning = tk.CTkButton(master=self.county_frame,text="!",width=10,hover=False,fg_color="red")
        ...
        self.county = SmartTextbox(main_master=self.master,master=self.county_frame,height=40,wrap="word",font=font,text_color=text_col,fg_color=bg_col,corner_radius=r)
        ...
        if warning!=False:
            ...
            self.plaintiff_warning = tk.CTkButton(master=self.plaintiff_frame,text="!",width=10,hover=False,fg_color="red")
        ...
        self.plaintiff = SmartTextbox(main_master=self.master,master=self.plaintiff_frame,height=40,wrap="word",font=font,text_color=text_col,fg_color=bg_col,corner_radius=r)
        ...
        if warning!=False:
            ...
            self.defendant_warning = tk.CTkButton(master=self.defendant_frame,text="!",width=10,hover=False,fg_color="red")
        ...
        self.defendant = SmartTextbox(main_master=self.master,master=self.defendant_frame,height=40,wrap="word",font=font,text_color=text_col,fg_color=bg_col,corner_radius=r)
        ...
        if warning!=False:
            propounding_party = tk.CTkLabel(master=self.propounding_frame,text="Propounding Party:",anchor="nw",width=110)
            propounding_party.pack(side="left",padx=(20,10))
            self.propounding_warning = tk.CTkButton(master=self.propounding_frame,text="!",width=10,hover=False,fg_color="red")
        ...
        self.propounding_party = SmartTextbox(main_master=self.master,master=self.propounding_frame,height=40,wrap="word",font=font,text_color=text_col,fg_color=bg_col,corner_radius=r)
        ...
        if warning!=False:
            responding_party = tk.CTkLabel(master=self.responding_frame,text="Responding Party:",anchor="nw",width=110)
            responding_party.pack(side="left",padx=(20,10))
            self.responding_warning = tk.CTkButton(master=self.responding_frame,text="!",width=10,hover=False,fg_color="red")
        ...
        self.responding_party = SmartTextbox(main_master=self.master,master=self.responding_frame,height=40,wrap="word",font=font,text_color=text_col,fg_color=bg_col,corner_radius=r)
        ...
        self.case = SmartTextbox(main_master=self.master,master=self.case_frame,height=40,wrap="word",font=font,text_color=text_col,fg_color=bg_col,corner_radius=r)
        ...
        self.date = SmartTextbox(main_master=self.master,master=self.date_frame,height=40,wrap="word",font=font,text_color=text_col,fg_color=bg_col,corner_radius=r)
