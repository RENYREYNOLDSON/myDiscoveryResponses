...
class Request:
    def __init__(self, req, resp, no, master, req_type, custom_key=""):
        ...
        self.RFA_text = "(a) " + str(
            no + 1) + ". Responding Party reasserts any and all objections to this request and incorporates them here by reference.\n(b) Facts supporting response\n(c) People with knowledge of facts supporting response\n(d) Documents supporting response"
        ...
        if custom_key != "":
            ...
            self.RFA_text = "(a) " + str(
                custom_key) + ". Responding Party reasserts any and all objections to this request and incorporates them here by reference.\n(b) Facts supporting response\n(c) People with knowledge of facts supporting response\n(d) Documents supporting response"
        else:
